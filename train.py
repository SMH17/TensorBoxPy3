...
#e.g. python3 train.py --hypes hypes/inception_rezoom.json --gpu 0 --max_iter 5000 --logdir output
#will train model using inception_rezoom.json with 5000 iterations using GPU 0
